...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 15 13:12:42 2021
...
class InitalBlock(nn.Module):
    '''This class performs convolution, batch normalisation, max-pooling and
    uses activation function such as PreReLu or ReLu on the input'''
...
class BottleNeck(nn.Module):
    ''' This class creates custom bottlenecks according to the position of the 
    bottlneck'''
...
class ENet(BaseModel):
    ''' This class defines the architecture of Enet'''
    ...
    def get_backbone_params(self):
        # There is no backbone for enet, all the parameters are trained from scratch
        return []
